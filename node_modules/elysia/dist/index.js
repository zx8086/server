...
E.Cookie({},this.config.cookie),{dynamic:!this.config.aot,models:t,additionalProperties:!0}));let p={body:d(s?.body??this.validator?.body,{dynamic:!this.config.aot,models:t}),headers:d(s?.headers??this.validator?.headers,{dynamic:!this.config.aot,models:t,additionalProperties:!0}),params:d(s?.params??this.validator?.params,{dynamic:!this.config.aot,models:t}),query:d(s?.query??this.validator?.query,{dynamic:!this.config.aot,models:t}),cookie:l,response:f(s?.response??this.validator?.response,{dynamic:!this.config.aot,models:t})},m=c(this.event,s),v=h.endsWith("/")?h.slice(0,h.length-1):h+"/";if(!1===this.config.aot){this.dynamicRouter.add(e,h,{validator:p,hooks:m,content:s?.type,handle:r}),!1===this.config.strictPath&&this.dynamicRouter.add(e,v,{validator:p,hooks:m,content:s?.type,handle:r}),this.routes.push({method:e,path:h,composed:null,handler:r,hooks:m});return}let y=n({path:h,method:e,hooks:m,validator:p,handler:r,handleError:this.handleError,onRequest:this.event.request,config:this.config,definitions:i?this.definitions.type:void 0,schema:i?this.schema:void 0,getReporter:()=>this.reporter}),g=this.routes.findIndex(t=>t.path===h&&t.method===e);if(-1!==g&&// remove route previously defined
