...
o.includes(e?.$elysiaChecksum)||t.push(e);return t};export const mergeHook=(e,r)=>({// Merge local hook first
    ...
    r?.detail??{},// @ts-ignore
    e?.detail??{}),parse:mergeObjectArray(e?.parse??[],r?.parse??[]),transform:mergeObjectArray(e?.transform??[],r?.transform??[]),beforeHandle:mergeObjectArray(e?.beforeHandle??[],r?.beforeHandle??[]),afterHandle:mergeObjectArray(e?.afterHandle??[],r?.afterHandle??[]),onResponse:mergeObjectArray(e?.onResponse??[],r?.onResponse??[]),trace:mergeObjectArray(e?.trace??[],r?.trace??[]),error:mergeObjectArray(e?.error??[],r?.error??[])});export const getSchemaValidator=(e,{models:o={},additionalProperties:a=!1,dynamic:n=!1})=>{if(!e||"string"==typeof e&&!(e in o))return;let s="string"==typeof e?o[e]:e;return("object"===s.type&&"additionalProperties"in s==!1&&(s.additionalProperties=a),n)?{schema:s,references:"",checkFunc:()=>{},code:"",Check:e=>r.Check(s,e),Errors:e=>r.Errors(s,e),Code:()=>""}:t.Compile(s)};export const getResponseSchemaValidator=(o,{models:a={},additionalProperties:n=!1,dynamic:s=!1})=>{if(!o||"string"==typeof o&&!(o in a))return;let i="string"==typeof o?a[o]:o,l=e=>s?{schema:e,references:"",checkFunc:()=>{},code:"",Check:t=>r.Check(e,t),Errors:t=>r.Errors(e,t),Code:()=>""}:t.Compile(e);if(e in i)return"additionalProperties"in i==!1&&(i.additionalProperties=n),{200:l(i)};let p={};return Object.keys(i).forEach(r=>{let t=i[+r];if("string"==typeof t){if(t in a){let o=a[t];o.type,// Inherits model maybe already compiled
p[+r]=e in o?l(o):o}return}"object"===t.type&&"additionalProperties"in t==!1&&(t.additionalProperties=n),// Inherits model maybe already compiled
p[+r]=e in t?l(t):t}),p};// https://stackoverflow.com/a/52171480
export const checksum=e=>{let r=9;for(let t=0;t<e.length;)r=Math.imul(r^e.charCodeAt(t++),387420489);return r^r>>>9};export const mergeLifeCycle=(e,r,t)=>{let o=e=>(t&&// @ts-ignore
