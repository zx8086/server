...
export type TypedResponseInit<TStatusCode extends StatusCode = 200> = Omit<ResponseInit, 'status'> & {
    status: TStatusCode;
};
...
export type TypedResponseCtor = Omit<typeof Response, 'json'> & {
    ...
    json<TJSON, TStatusCode extends StatusCode>(value: TJSON, init: TypedResponseInit<TStatusCode>): TypedResponse<TJSON, Record<string, string>, TStatusCode>;
